...
//
// Derived from: templates/code/c/CODE-C-001-C-source.c (root template)
// See: standards/code/4-block/ for complete documentation
//
// Compiler-Specific Adaptations:
//   - C implementation files for compiler backend (codegen, runtime)
//   - Integration with CPI-SI health scoring
//   - Memory management patterns for compiler infrastructure
//
// ═══════════════════════════════════════════════════════════════════════════
